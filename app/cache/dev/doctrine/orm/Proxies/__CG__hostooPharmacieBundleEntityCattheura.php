 ...
 */
class Cattheura extends \hostoo\PharmacieBundle\Entity\Cattheura implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'hostoo\\PharmacieBundle\\Entity\\Cattheura' . "\0" . 'id', '' . "\0" . 'hostoo\\PharmacieBundle\\Entity\\Cattheura' . "\0" . 'nom', '' . "\0" . 'hostoo\\PharmacieBundle\\Entity\\Cattheura' . "\0" . 'produit'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Cattheura $proxy) {
