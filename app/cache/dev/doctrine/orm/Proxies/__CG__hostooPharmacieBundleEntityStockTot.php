 ...
 */
class StockTot extends \hostoo\PharmacieBundle\Entity\StockTot implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'hostoo\\PharmacieBundle\\Entity\\StockTot' . "\0" . 'id', '' . "\0" . 'hostoo\\PharmacieBundle\\Entity\\StockTot' . "\0" . 'qte', '' . "\0" . 'hostoo\\PharmacieBundle\\Entity\\StockTot' . "\0" . 'produit'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StockTot $proxy) {
