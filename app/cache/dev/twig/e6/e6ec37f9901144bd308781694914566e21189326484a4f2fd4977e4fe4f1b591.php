...
class __TwigTemplate_8bc8fbf91a85f59d882c0a580f14e3978ab15a74639dae7b4f04b8b663218a8a extends Twig_Template
{
    ...
    ";
        ...
        <div id=\"tree-details-container\">
            ...
            foreach ($context['_seq'] as $context["formName"] => $context["formData"]) {
                // line 197
                echo "                ";
                echo $context["__internal_a31beb56abba4ef9c7526f4694dcb8d47d3de812d5e8c134ada9f0bb4b64ce9d"]->getform_tree_details($context["formName"], $context["formData"], $this->getAttribute($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "data", []), "forms_by_hash", []));
                echo "
            ";
            }
            $_parent = $context['_parent'];
...
{% macro form_tree_details(name, data, forms_by_hash) %}
    ...
    {% endfor %}
{% endmacro %}
", "@WebProfiler/Collector/form.html.twig", "C:\\wamp64\\www\\hostoo\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle\\Resources\\views\\Collector\\form.html.twig");
    }
}
