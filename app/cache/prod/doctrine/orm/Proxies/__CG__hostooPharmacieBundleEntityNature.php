 ...
 */
class Nature extends \hostoo\PharmacieBundle\Entity\Nature implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'hostoo\\PharmacieBundle\\Entity\\Nature' . "\0" . 'id', '' . "\0" . 'hostoo\\PharmacieBundle\\Entity\\Nature' . "\0" . 'nom', '' . "\0" . 'hostoo\\PharmacieBundle\\Entity\\Nature' . "\0" . 'produit'];
        }
