 ...
 */
class Service extends \hostoo\SanteBundle\Entity\Service implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'hostoo\\SanteBundle\\Entity\\Service' . "\0" . 'id', '' . "\0" . 'hostoo\\SanteBundle\\Entity\\Service' . "\0" . 'nomservice', '' . "\0" . 'hostoo\\SanteBundle\\Entity\\Service' . "\0" . 'service'];
        }
