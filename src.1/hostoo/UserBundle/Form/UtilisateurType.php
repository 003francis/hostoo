    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
           ...
           ->add('roles',ChoiceType::class,array('choices'=>array('ROLE_RECEPTION'=>'ROLE_RECEPTION','ROLE_MEDECIN'=>'ROLE_MEDECIN'
            ,'ROLE_INFIRMIER'=>'ROLE_INFIRMIER','ROLE_CAISSIER'=>'ROLE_CAISSIER','ROLE_SUPER_ADMIN'=>'ROLE_SUPER_ADMIN','ROLE_LABORATOIRE'=>'ROLE_LABORATOIRE','ROLE_IMAGERIE'=>'ROLE_IMAGERIE', 'ROLE_REPORT'=>'ROLE_REPORT'),'expanded' => false,
                   'multiple' => true,))
