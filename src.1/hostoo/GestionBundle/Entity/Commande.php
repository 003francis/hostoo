...
class Commande
{
    ...
    /**
     *
     * @ORM\ManyToOne(targetEntity="hostoo\SanteBundle\Entity\Facture", inversedBy="commandes")
     */
    private $facture;
     ...
     *
     *
     * @ORM\ManyToMany(targetEntity="Tarif", cascade={"persist"}, inversedBy="commandes")
     */
    private $tarifs;
