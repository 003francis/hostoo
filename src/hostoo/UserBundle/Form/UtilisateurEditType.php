...
class UtilisateurEditType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ,'ROLE_INFIRMIER'=>'ROLE_INFIRMIER','ROLE_CAISSIER'=>'ROLE_CAISSIER','ROLE_SUPER_ADMIN'=>'ROLE_SUPER_ADMIN','ROLE_LABORATOIRE'=>'ROLE_LABORATOIRE','ROLE_IMAGERIE'=>'ROLE_IMAGERIE','ROLE_DG'=>'ROLE_DG'),'expanded' => false,
                'multiple' => true,'choices_as_values' => true))
           ...
           /* ->add('roles',ChoiceType::class,array('choices'=>array('ROLE_RECEPTION'=>'ROLE_RECEPTION','ROLE_MEDECIN'=>'ROLE_MEDECIN'
            ,'ROLE_INFIRMIER'=>'ROLE_INFIRMIER','ROLE_CAISSIER'=>'ROLE_CAISSIER'),'choices_as_values' => true))*/
        ;
    }
    ...
    {
        return 'hostoo_user_utilisateuredit';
    }
}
