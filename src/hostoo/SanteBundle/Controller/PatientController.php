...
class PatientController extends Controller
{
    ...
    public function voirPatientAction(Request $request,$id)
    {
		...
		//var_dump($RDV);
        $tar1=$em->getRepository('hostooGestionBundle:Tarif')->find(5);
        ...
        $actess=$em->getRepository('hostooGestionBundle:Tarif')->findAll(100);
        
        
        
        
        //$actess=$em->getRepository('hostooGestionBundle:Tarif')->findEpisode($liste->getSociete()->getConvention());
