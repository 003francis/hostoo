...
use hostoo\MsgBundle\Entity\Message;
use hostoo\MsgBundle\Form\MessageType;
...
class MessageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $messages = $em->getRepository('hostooMsgBundle:Message')->findAll();
    ...
    {
        $message = new Message();
        $form = $this->createForm('hostoo\MsgBundle\Form\MessageType', $message);
    ...
    {
        $deleteForm = $this->createDeleteForm($message);
        $editForm = $this->createForm('hostoo\MsgBundle\Form\MessageType', $message);
